const Header = () => {
  return (
    // <header className="relative flex max-w-screen-xl flex-col overflow-hidden px-4  py-10 text-blue-900 md:mx-auto md:flex-row md:items-center">
    //   <a
    //     href="#"
    ...
    //   <label
    //     className="absolute top-12 right-7 cursor-pointer md:hidden"
    //     htmlFor="navbar-open"
    //   >
    ...
    <div className="bg-gray-900">
      <header className="relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-10 text-blue-900 md:mx-auto md:flex-row md:items-center">
        ...
        <input type="checkbox" className="peer hidden" id="navbar-open" />
        <label
          className="absolute top-12 right-7 cursor-pointer md:hidden text-blue-600"
          htmlFor="navbar-open"
        >
          <span className="sr-only">Toggle Navigation</span>
          <svg
